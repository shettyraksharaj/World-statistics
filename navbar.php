<nav class="navbar navbar-dark bg-dark">
      ...
      <li style="border-left: 1px solid #000000; " class="dropdown" >
         <a style="margin:  0px 10px 0px 15px; height:100% ;text-decoration:none" href="#" class="dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span style='Color:#ffffff; font-weight:500;'><?= $_SESSION['name']?></span>  <img class="rounded-circle" src="<?= $_SESSION['propho']?>" style=" margin-top: 3px; margin-right: -30px; margin-bottom: 2px; display:inline-block; width:35%; height:80%;"> </a>
